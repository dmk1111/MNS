//noinspection TsLint
export const rankEditModalHtml = `
  ...
  <div class="modal-dialog" >
    <div class="modal-content">
      ...
      <div class="modal-body">
         ...
         <!---->
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">          
                <input type="text" class="form-control" [(ngModel)]="rank.code" id="pwd" placeholder="Ведіть Код" [ngModelOptions]="{standalone: true}">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">          
                <input type="text" class="form-control" id="pwd" [(ngModel)]="rank.comment" placeholder="Ведіть Назву"[ngModelOptions]="{standalone: true}">
              </div>
            </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" style="float: left" (click)="deletePosition()" *ngIf="isCreate">Видалити</button>
